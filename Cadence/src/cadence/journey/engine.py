...
from cadence.classify.classifier import (
    SOURCE_LLM,
    SOURCE_STICKY,
    Classification,
    classify,
...
from cadence.clock import Clock, parse_iso, utc_iso
...
from cadence.policy.guardian import (
...
from cadence.policy.bandit import (
...
from cadence.policy.timing import hold_release_shift, next_contactable_moment, retry_delay_for_cause
...
class RecoveryEngine:
    ...
    def _dispatch_fast_path(
        ...
        *,
        ...
        # in `cadence.policy.bandit` scores every legal move for the cause
