"""Cadence application configuration.
...
def load_config() -> AppConfig:
    ...
    return AppConfig(
        ...
        db_path=Path(os.environ.get("DB_PATH", "data/cadence.db")),
        log_level=os.environ.get("LOG_LEVEL", "INFO").upper(),
        razorpay=RazorpayConfig(
            key_id=os.environ.get("RZP_KEY_ID", ""),
            key_secret=os.environ.get("RZP_KEY_SECRET", ""),
            webhook_secret=os.environ.get("RZP_WEBHOOK_SECRET", "cadence_dev_webhook_secret"),
        ),
        llm=LLMConfig(
