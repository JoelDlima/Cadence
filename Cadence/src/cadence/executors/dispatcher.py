...
from cadence.agents.ptp_parser import KIND_REFUSAL, parse_reply, ptp_to_timer_days
...
from cadence.executors.razorpay_client import RazorpayLike
from cadence.journey import fsm
from cadence.journey.fsm import IllegalTransition
...
class Dispatcher:
    ...
    def _requeue_outcome_check(
        ...
        *,
        ...
        """
        from cadence.executors.contracts import InterventionRequest
