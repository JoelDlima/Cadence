...
Run from main/:  python scripts/live_check.py

Reads main/.env (via load_config) and probes each integration with the
...
def main() -> None:
    ...
    print("LIVE wiring: paste keys into main/.env (copy .env.example), rerun.")
