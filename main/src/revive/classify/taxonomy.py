...
LEGAL_MOVES: dict[str, frozenset[str]] = {
    NO_FUNDS: frozenset(
        {RETRY_PAYDAY, SWITCH_METHOD, GRACE_OFFER, WHATSAPP_NUDGE, EMAIL_NUDGE, PAYMENT_LINK}
    ),
    BANK_DOWN: frozenset({RETRY_LATER, WHATSAPP_NUDGE, EMAIL_NUDGE}),
    TIMEOUT: frozenset({RETRY_LATER, PAYMENT_LINK, WHATSAPP_NUDGE, EMAIL_NUDGE}),
