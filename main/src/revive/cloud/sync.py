...
The schema for the three mirrored tables lives in `main/supabase/schema.sql`
(run once in Supabase Studio -> SQL Editor).

Design choices documented in `main/docs/cloud-mirror.md`:
...
from revive.events import E_INTERVENTION_VETOED
from revive.logging_setup import get_logger
from revive.store.db import Database
from revive.store.journey_repo import STATE_RECOVERED

log = get_logger("revive.cloud.sync")
